...
public class CategoriesDao {
    ...
    public boolean updateCategoryQuery(Categories category){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Error al actualizar los datos de la categoria "+ e);
            return false;
        }
    }
    ...
    //eliminar categoria
        ...
        JOptionPane.showMessageDialog(null, "Error, no se pudo eliminar la categoria");
        return false;
 }
 }
